"""
Unit tests for the safe_division module (broken version for red light demonstration).
This will fail when division by zero handling is removed.
"""

import unittest
from safe_division_broken import safe_division
